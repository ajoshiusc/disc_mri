...
diff_0_55T = np.array(data_0_55T["First Repetition"]) - np.array(
    data_0_55T["Second Repetition"]
)
mean_0_55T = (
    np.array(data_0_55T["First Repetition"]) + np.array(data_0_55T["Second Repetition"])
) / 2

diff_3T = np.array(data_3T["First Repetition"]) - np.array(data_3T["Second Repetition"])
mean_3T = (
    np.array(data_3T["First Repetition"]) + np.array(data_3T["Second Repetition"])
) / 2
...
plt.axhline(
    np.mean(diff_0_55T) + 1.96 * np.std(diff_0_55T),
    color="gray",
    linestyle="--",
    label="Upper LoA",
)
...
plt.axhline(
    np.mean(diff_3T) + 1.96 * np.std(diff_3T),
    color="gray",
    linestyle="--",
    label="Upper LoA",
)

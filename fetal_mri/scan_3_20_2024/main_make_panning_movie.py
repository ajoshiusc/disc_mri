...
nifti_file = "/deneb_disk/disc_mri/scan_3_20_2024/outsvr/svr_te140_numstacks_10_iter_0_aligned.nii.gz"  # Replace with your input NIfTI file
img = nib.load(nifti_file)
data = img.get_fdata()
data = 1.5 * 255.0 * data / np.max(data)

# Define the output GIF file
output_gif = "svr_te140_3_20_2024.gif"

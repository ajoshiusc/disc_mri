...
stacks = glob.glob(subdir+'/*head*te181*p.nii.gz')
...
for num_stacks in range(1, len(stacks)+1):
    ...
    outsvr = subdir + '/outsvr'+'_te181_'+str(num_stacks)+'.nii.gz'
    outsvr_aligned = subdir + '/outsvr'+'_te181_'+str(num_stacks)+'_aligned.nii.gz'

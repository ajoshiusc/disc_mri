...
nifti_file = '/deneb_disk/disc_mri/scan_8_11_2023/outsvr/svr_te98_numstacks_12_iter_0_aligned.nii.gz'  # Replace with your input NIfTI file
img = nib.load(nifti_file)
data = img.get_fdata()
data=1.5*255.0*data/np.max(data)

# Define the output GIF file
output_gif = 'sub_panning_movie_z.gif'

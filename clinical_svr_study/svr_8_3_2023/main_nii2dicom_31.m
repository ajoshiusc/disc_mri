...
%dicom_file='/home/ajoshi/projects/disc_mri/clinical_svr_study/svr_8_3_2023/SVR_aligned_randomized_31_dicom/RND_0001_SVR_aligned/IM_slice_001.dcm'

%'/home/ajoshi/projects/disc_mri/clinical_svr_study/SVR_3D_DICOM/SVR010_SVR_3D/IM_0044';

for sub=1:31

    subid=sprintf('%04d',sub)
    nii_file = ['/home/ajoshi/projects/disc_mri/clinical_svr_study/svr_8_3_2023/svr_aligned_randomized_31/RND_',subid,'_SVR_aligned_canonical.nii.gz'];
    
    write_dir = ['/home/ajoshi/projects/disc_mri/clinical_svr_study/svr_8_3_2023/SVR_aligned_randomized_31_dicom/RND_',subid,'_SVR_aligned'];
    
    mkdir(write_dir);
    write_name = 'IM';
    dinfo = dicominfo(dicom_file);
    
    dinfo.PatientName.FamilyName = 'ANONYMIZED';
     dinfo.PatientAge='';
     dinfo.PatientSex='';
    dinfo.EthnicGroup='';
    dinfo.PatientWeight='';

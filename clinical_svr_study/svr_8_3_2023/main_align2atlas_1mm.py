...
subdirs = glob.glob('/deneb_disk/SVR_8_3_2023/svr_output_manual_mask/Svr*/S*_SVR.nii.gz')
...
for sub in subdirs:
    ...
    cmd = 'flirt -in ' + sub + ' -ref '+ atlas +' -out ' + sub_aligned+' -dof 6 -omat reorient.mat -searchrx -180 180 -searchry -180 180 -searchrz -180 180 -cost normmi'

...
for sess, n in product((1,2), range(1,nsub+1)):
    sub_nii = glob.glob('/deneb_disk/3T_vs_low_field/low_field_mprage_data/subj' + str(n) + '_vol' + str(sess) + '/*.nii')[0]
    out_dir = '/deneb_disk/3T_vs_low_field/low_field_mprage_data_BrainSuite_SynthSR/subj' + str(n) + '_vol' + str(sess) 

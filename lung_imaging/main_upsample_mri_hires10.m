...
v1=load_untouch_nii('lung10_dejitter_10.nii.gz');
...
for j = 1:size(v1.img,3)-1
    ...
    [~,~,~,Tx1,Ty1] = demon_image_registration(I1,I2);
    [~,~,~,Tx2,Ty2] = demon_image_registration(I2,I1);
    close all;drawnow;
...
save_untouch_nii_gz(vout,'lung10_dejitter_10_up2.nii.gz');

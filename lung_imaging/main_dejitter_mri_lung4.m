...
v1=load_untouch_nii('/ImagePTE1/ajoshi/data/LungCancerDICOMs_forAnand/_t2_fblade_tra_trig_320_20220303131541_4.nii.gz');%('/home/ajoshi/Desktop/tmp/haste.nii.gz');
...
for dejitter=1:10
    ...
    save_untouch_nii_gz(vout,sprintf('lung4_dejitter_%d.nii.gz',dejitter));

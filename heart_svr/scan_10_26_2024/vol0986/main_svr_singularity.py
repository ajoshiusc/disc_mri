...
if __name__ == "__main__":
    ...
    expmt_dir_all = glob.glob(scans_dir_top + "/v0986*")

    for phase, expmt_dir in product(range(25), expmt_dir_all):

        res = 1.0
        subdir = expmt_dir + f"/phase_{phase+1:02}_rot"
        template = "/project/ajoshi_27/disc_mri/heart_svr_acquisition_10_26_2024/vol0986_template/p57_cardiac_svr_sweep_1_res_15.nii.gz"

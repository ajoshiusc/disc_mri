...
if __name__ == "__main__":
    ...
    for phase, expmt_dir in product(range(25), expmt_dir_all):
        ...
        template = "/project/ajoshi_27/disc_mri/heart_svr_acquisition_10_26_2024/vol1003_template/p55_cardiac_svr_sweep_1_res_15.pad.nii.gz"
        mask = "/project/ajoshi_27/disc_mri/heart_svr_acquisition_10_26_2024/vol1003_template/p55_cardiac_svr_sweep_1_res_15.pad.dilated.mask.nii.gz"

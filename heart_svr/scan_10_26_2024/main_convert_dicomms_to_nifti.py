...
scans_dir_top = (
    "/deneb_disk/disc_mri/disc_mri/heart_svr_acquisition_10_26_2024/heart_arrhythmia/heart_arrhythmia"
)
...
for phase, expmt_dir in product(range(25), expmt_dir_all):
    ...
    for stack_dir in stack_dir_all:
        ...
        out_expmt_dir = "/deneb_disk/disc_mri/disc_mri/heart_svr_acquisition_10_26_2024/nifti_files/" + expmt_dir.split('/')[-1] 

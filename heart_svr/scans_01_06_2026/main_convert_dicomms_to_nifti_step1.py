...
scans_dir_top = ("/project2/ajoshi_27/data/heart_svr/heart_svr_acquisition_01_06_2026")
...
for phase, expmt_dir in product(range(25), expmt_dir_all):
    ...
    for stack_dir in stack_dir_all:
        ...
        out_expmt_dir = "/project2/ajoshi_27/data/heart_svr/heart_svr_acquisition_01_06_2026/nifti_files/" + expmt_dir.split('/')[-1] 

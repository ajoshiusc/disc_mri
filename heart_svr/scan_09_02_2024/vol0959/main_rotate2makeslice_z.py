...
def main():
    ...
    #scans_dir_top =  '/deneb_disk/disc_mri/heart_svr_acquisition_08_22_2024/vol0950/nifti_files'
    #expmt_dir_all = [scans_dir_top] #glob.glob(scans_dir_top + "/*")

    scans_dir_top = "/deneb_disk/disc_mri/heart_svr_acquisition_09_02_2024/nifti_files"
    ...
    for phase, expmt_dir in product(range(25),expmt_dir_all):
        ...
        for stack_dir in stack_dir_all:
            ...
            out_expmt_dir = "/deneb_disk/disc_mri/heart_svr_acquisition_09_02_2024/nifti_files/" + expmt_dir.split('/')[-1] 

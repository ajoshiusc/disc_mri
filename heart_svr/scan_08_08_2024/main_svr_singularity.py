...
if __name__ == "__main__":
    ...
    expmt_dir_all = [
        "/project/ajoshi_27/disc_mri/heart_svr_acquisition_08_08_2024/nifti_files/res_1.5_thickness_6_with_motion",
        "/project/ajoshi_27/disc_mri/heart_svr_acquisition_08_08_2024/nifti_files/res_1.5_thickness_6",
        "/project/ajoshi_27/disc_mri/heart_svr_acquisition_08_08_2024/nifti_files/res_1.5_thickness_4",
    ...
    for phase, expmt_dir in product(range(25), expmt_dir_all):
        ...
        outsvr_dir = "/project/ajoshi_27/disc_mri/heart_svr_acquisition_08_08_2024/outsvr/" + expmt_dir.split("/")[-1] +"/phase_" + str(phase+1).zfill(2)

...
if __name__ == "__main__":
    ...
    expmt_dir_all = [
        "/project/ajoshi_27/disc_mri/heart_svr_acquisition_08_08_2024/nifti_files_experiments/res_1.5_thickness_6"
    ]  # glob.glob(scans_dir_top + "/*")

    for phase, expmt_dir in product(range(25), expmt_dir_all):

        res = 1.0
        subdir = expmt_dir + f"/phase_{phase+1:02}_rot_downsampled2"
        ...
        outsvr_dir = "/project/ajoshi_27/disc_mri/heart_svr_acquisition_08_08_2024/nifti_files_experiments/outsvr_pad_downsampled2/" + f"phase_{phase+1:02}_expt_{expdir_prefix}"
